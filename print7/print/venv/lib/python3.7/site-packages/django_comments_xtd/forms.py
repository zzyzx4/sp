...
class XtdCommentForm(CommentForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['email'] = forms.EmailField(
            label=_("Почта"), help_text=_("Required for comment verification"),
            widget=forms.TextInput(attrs={'placeholder': _('Электронная почта'),
                                          'class': 'form-control'}))
        # self.fields['url'] = forms.URLField(
        #     label=_("Link"), required=False,
        #     widget=forms.TextInput(attrs={
        #         'placeholder': _('url your name links to (Опционально)'),
        #         'class': 'form-control'}))
        self.fields['comment'] = forms.CharField(label='Комментарии',
            widget=forms.Textarea(attrs={'placeholder': _('Введите комментарии'),
                                         'class': 'form-control'}),
