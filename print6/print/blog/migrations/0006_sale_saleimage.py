    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='KZT', max_digits=14)),
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from='product', unique_with=('category',))),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sale_category', to='blog.Category', verbose_name='Категория')),
                ('tag', models.ManyToManyField(related_name='sale_tag', to='blog.Tags', verbose_name='Тэг')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='sale/%Y/%m', verbose_name='фото')),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='blog.Sale')),
            ],
        ),
    ]
